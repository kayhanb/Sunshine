/**
 * @file src/platform/windows/vhid_bridge.h
 * @brief virtual HID driver backend (keyboard + mouse).
 *
 * When the virtual input UMDF HID minidriver (virtual inputVhid) is installed, keyboard and
 ...
 *
 * Report contract: the driver's report contract (vendor 0x4C43, product 0x0001).
 */
#pragma once
...
namespace platf::vhid_bridge {
  ...
  public:
    ...
    /**
     * @brief Find and open the virtual input control collection.
